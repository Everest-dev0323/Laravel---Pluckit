...
      url: BASE_URL + '/view-workinghours',
 ...
 $(".search_button").on('click', function(){
         ...
         $(".page-head-search").after(`<section class="search-waiting"> <div class="container"> <p><i class="fa fa-spinner fa-spin"></i>  Hold those horses, we’re just fetching the recommendations for you... </p></div></section>`);
