...
<div id="content">
				...
				<h5>Personal Information</h5>
				  ...
				  {{ csrf_field()}}
					...
					<div class="form-group">
					  ...
					  <input type="text" name="postcode" id="postcode" class="form-control" placeholder="2445" data-parsley-type="number" minlength="1" maxlength="4" value="{{ !empty($getUser->postcode) ? $getUser->postcode : ''}}">
					</div>
		...
		<aside id="sidebar" class="col-lg-4 pl-lg-5">
		  ...
		  <div class="box bg-gray-light box-shadow">
			<ul class="list-unstyled import-contacts">
			  <li><a href="{{ route('fb.import') }}" class="facebook"><span class="icon2"><i class="fab fa-facebook-f"></i></span>Import
				  From Facebook</a></li>
			@php
  ...
  <div class="modal fade" id="import-contact-view">
...
$(document).ready(function() {
	<?php if(!empty($getNewUser)) { ?>
	   $('#import-contact-view').modal('show', {backdrop: 'static'});
    <?php } ?>
