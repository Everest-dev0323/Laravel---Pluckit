          ...
          <div class="row">
            ...
            <main id="main" class="col-lg-8 pr-lg-5">
		      ...
		      @elseif(!empty($get['cat']) && !empty($get['loc']))
			     @php $allUrl = url('search').'?cat='.$get['cat'].'&loc='.$get['loc'].'&hid_type='.$get['hid_type'];@endphp
			  ...
			  @elseif(!empty($get['cat']))
			     @php $allUrl = url('search').'?cat='.$get['cat'].'&hid_type='.$get['hid_type']; @endphp
				 @if($objBusinessListCont !=0)
			         <h3 class="mb-2 mb-md-0">Top {{ $objBusinessListCont.' '.$get['cat'] }} near you</h3>
			     @else
					 <h3 class="mb-2 mb-md-0">{{ 'No ' .$get['cat'] }} near you</h3>
			  ...
			  @else
				   @php $allUrl = url('search').'?loc='.$get['loc'].'&hid_type='.$get['hid_type'];@endphp
              ...
              <div class="search-filter">
                ...
                <div class="filter-nav">
                  <form action="{{ url('search/') }}" method="" class="form" id="get-filter-form">
                    <div class="search-by">
					  ...
					  <input type="hidden" name="cat" id="" value="{{ !empty($get['cat']) ? $get['cat'] : '' }}">
                    ...
                    <div class="service-box">
					  ...
					  <a href="{{ !empty($business->business_slug) ? url('business').'/'.$business->business_slug : '#' }}">
						 @if(!empty($business->business_image))
						  ...
						  @else
							<img class="img-fluid" src="{{ url('public/')}}/front-assets/images/default-image.png" alt="butterfield">
						  @endif
					  </a>
                      </div>
					 ...
					 @foreach($objRelatedBusinessList as $relatedBusinessList)
                        <li class="media">
                            ...
                            <a href="{{ url('/business/'.$relatedBusinessList->business_slug) }}">
							  <img class="img-fluid" src="{{ (!empty($relatedBusinessList->business_image))?$relatedBusinessList->business_image:url('/public/front-assets/images/default-image.png') }}" alt="{{ $relatedBusinessList->business_name }}">
							</a>
                            </figure>
                            <div class="media-body">
