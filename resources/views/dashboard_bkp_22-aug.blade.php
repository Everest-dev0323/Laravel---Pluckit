		  ...
		  <div class="col-sm-6 col-lg-8 pr-lg-5">
			...
			<div class="media mb-3">
				<div class="profile-pic position-relative">
					...
					<a href="javascript:;" class="btn btn-dark btn-edit position-absolute save_profile_image d-none" id="save_profile_image" title="Save Profile Image"><i class="fas fa-check"></i></a>
					@if(!empty($getUser->user_image))
						<img class="img-fluid" src="{{ $getUser->user_image }}" alt="{{ Auth::user()->name }}" id="profile_image">
					@else
						<img class="img-fluid" src="{{ ('/public') }}/front-assets/images/default-profile.jpg" alt="Avatar" id="profile_image">
					@endif
					<form action="{{ url('user/profile/image/update') }}" method="post" id="get-form-image" enctype="multipart/form-data">
					  {{ csrf_field()}}
					...
					<div class="title">{{ !empty($getUser->profile_text) ? $getUser->profile_text : '' }}
                ...
                <form action="" class="form">
                  <div class="row">
                    <div class="col-12 text-right">
                      <button type="button" class="btn btn-primary first_step_click">Continue</button>
                    </div>
                  </div>
                </form>
              </div>
                ...
                <form action="{{ url('/search')}}" class="form"  method="get" id="get-form-third-step">
                  <div class="row">
                    ...
                    <div class="col-md-3 text-right">
					  <input type="hidden" name="near_postcode" id="near_postcode" value="25">
