...
@php
 ...
 @endphp
    ...
    <!-- /page-head-search -->
    <!-- Content -->
    <h1 class="d-none">{{ "Recommended ".$objBusinessList->category_name." near me | ".$objBusinessList->business_name }}</h1>
      ...
      <section class="section tradie-page">
        <div class="container">
          <div class="row">
				...
				<div class="service-content">
                   ...
                   <div class="right">
					  ...
					  @if(!empty($objBusinessList->business_phone))
						...
						@endif
						@if(!empty($objBusinessList->business_phone))
							@if(strpos($objBusinessList->business_phone,'04')!==false || strpos($objBusinessList->business_phone,'+614')!==false)
			...
			<?php //echo "<pre>";var_dump($getPeopleYouMightKnow);exit;?>
...
function getPeopleYouMightKnow() {
		...
		if(fullUrl == currentURL){
			var serviceUrl = fullUrl +'?business-page='+ $(businesspage).val();
		}else{
			var serviceUrl = fullUrl +'&business-page='+ $(businesspage).val();
		}
			...
			$.ajax({
				...
				if(businesspage != businessmaxpage){
					$('.load-more-business').html('<a href="javascript:;" class="btn btn-link button2 load-more">Load more<i class="fas fa-angle-down ml-2"></i></a>');
				}else{
