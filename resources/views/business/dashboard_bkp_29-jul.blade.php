    ...
    <div id="content">
      <section class="section">
        <div class="container pl-xl-0">
          <!-- business-card-info -->
          <div class="client-profile business-card-info">
            <div class="column">
                                ...
                                <div class="row">
                                  <div class="col-xl-6 p-md-0">
                                    <div class="upload-profile-image mb-0">
                                      <label>Your business Logo</label><br />
                                ...
                                <div class="row">
                                  <div class="col-xl-6">
                                    <div class="form-group">
                                      ...
                                      <input type="text" name="business_city" id="city" class="form-control" placeholder="e.g. sydney, albury" required value="{{ !empty($getUser->business_city) ? $getUser->business_city : '' }}">
                                    </div>
                                  </div>
                                  <div class="col-xl-6">
                                    <div class="form-group">
                                      <label for="postcode">Post code<span>*</span></label>
                                      <input type="text" data-parsley-type="number" minlength="5" maxlength="6" name="business_zipcode" id="postcode" class="form-control" placeholder="Post code" required value="{{ !empty($getUser->business_zipcode) ? $getUser->business_zipcode : '' }}">
                                    </div>
                                  </div>
                                </div>
                                <div class="row">
