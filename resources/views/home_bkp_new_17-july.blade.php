  ...
  <div id="content" class="pt-0">
    ...
    <section class="section recommendations promo-bg">
      <div class="container">
		...
		@php
		    $getBusiness = \App\BusinessListing::where('id',$review->business_id)->first();
			$category = \App\BusinessListingCategory::where('business_listing_categories.business_id',$review->business_id);
